...
# FILENAME = "../../radar_camera_sdk/data/cole_0/output/stream1R.bin" # m_aoa = -3.58
# FILENAME = "../../radar_camera_sdk/data/cole_45/output/stream1R.bin" # m_aoa = 45.9
FILENAME = "../../radar_camera_sdk/data/cole_-45/output/stream1R.bin" # m_aoa = -43
