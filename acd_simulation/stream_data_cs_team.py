...
# FILENAME = "../../radar_camera_sdk/data/cole_0/output/stream1R.bin"
FILENAME = "../../radar_camera_sdk/data/cole_45/output/stream1R.bin"
# FILENAME = "../../radar_camera_sdk/data/cole_-45/output/stream1R.bin"
