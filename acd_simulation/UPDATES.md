...
- [3/31] ```processing.py``` has basic aoa estimation (phase diff ->  angle using array geometry). 
Run ```stream_data_cs_team.py``` with ```IS_SNAPSHOT_MODE = False``` to test the 0, 45, -45 degrees cases